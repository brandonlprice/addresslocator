          ...
          .then(lang.hitch(this, function(layerInfosObj) {
            ...
            when(utils.getConfigInfo(this.config)).then(lang.hitch(this, function(config) {
              ...
              this.searchDijit = new Search({
                  ...
                  ///
                  minCharacters: 7,   /// kevin m override to speed up performance to stop it from requesting data from Locator services until at least 4 characters entered
                  ///
                allPlaceholder: jimuUtils.stripHTML(esriLang.isDefined(this.config.allPlaceholder) ?
                  this.config.allPlaceholder : ""),
                  autoSelect: true,
            //      enableSuggestions: false, // kevin m - this disables it on ALL geocoder services unfortunately! I wish I could make it just disabled on Esri locator
        ...
        var sourceDefs = array.map(config.sources, lang.hitch(this, function(source) {
          ...
          if (source && source.url && source.type === 'locator') {
            var _source = {
              ...
              zoomScale: source.zoomScale || 10000,
        ...
        if (layerInfo) {
          layerInfo.getLayerObject().then(lang.hitch(this, function(layer) {
            ...
            if (gs && gs.length > 0) {
              ...
              }), seTimeOut(lang.hitch(this, function() {
